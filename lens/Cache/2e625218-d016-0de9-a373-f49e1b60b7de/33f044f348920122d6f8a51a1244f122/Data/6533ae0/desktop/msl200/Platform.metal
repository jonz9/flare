...
//float Port_Rotation_N003 4752
//float2 Port_Center_N003 4760
//float depthRef 4768
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_planet_refl_map 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map 80 -1
//spec_const int Tweak_N6Layout 81 0
//spec_const int intensityTextureLayout 82 0
//spec_const int planet_refl_mapLayout 83 0
...
float2 param_17=UVCoord_N11;
float param_18=(*sc_set0.UserUniforms).Port_Rotation_N003;
float2 param_19=(*sc_set0.UserUniforms).Port_Center_N003;
float l9_90=sin(radians(param_18));
float l9_91=cos(radians(param_18));
float2 param_20=param_17-param_19;
param_20=float2(dot(float2(l9_91,l9_90),param_20),dot(float2(-l9_90,l9_91),param_20))+param_19;
CoordsOut_N3=param_20;
float4 Output_N2=float4(0.0);
float4 param_21=(*sc_set0.UserUniforms).Tweak_N2;
Output_N2=param_21;
float Output_N12=0.0;
float param_22=(*sc_set0.UserUniforms).colorRatio;
Output_N12=param_22;
float4 Output_N8=float4(0.0);
float4 param_23=(*sc_set0.UserUniforms).Tweak_N8;
Output_N8=param_23;
float4 Output_N9=float4(0.0);
float4 param_24=(*sc_set0.UserUniforms).Tweak_N9;
Output_N9=param_24;
float4 Value_N0=float4(0.0);
float param_25=CoordsOut_N3.x;
float4 param_26=Output_N2;
float param_27=Output_N12;
float4 param_28=Output_N8;
float4 param_29=Output_N9;
param_25=fast::clamp(param_25,0.0,1.0);
float4 param_30;
if (param_25<param_27)
{
param_30=mix(param_26,param_28,float4(fast::clamp(param_25/param_27,0.0,1.0)));
}
else
{
param_30=mix(param_28,param_29,float4(fast::clamp((param_25-param_27)/(1.0-param_27),0.0,1.0)));
}
bool l9_92=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_93;
if (l9_92)
{
...
if (l9_93)
{
l9_94=0==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_94=l9_93;
...
int l9_100=l9_95;
int param_31=Tweak_N6Layout_tmp;
int param_32=l9_100;
float2 param_33=UVCoord_N19;
bool param_34=(int(SC_USE_UV_TRANSFORM_Tweak_N6_tmp)!=0);
float3x3 param_35=(*sc_set0.UserUniforms).Tweak_N6Transform;
int2 param_36=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6_tmp);
bool param_37=(int(SC_USE_UV_MIN_MAX_Tweak_N6_tmp)!=0);
float4 param_38=(*sc_set0.UserUniforms).Tweak_N6UvMinMax;
bool param_39=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6_tmp)!=0);
float4 param_40=(*sc_set0.UserUniforms).Tweak_N6BorderColor;
float param_41=0.0;
...
float4 l9_167=sc_set0.Tweak_N6.sample(sc_set0.Tweak_N6SmpSC,l9_166.xy,bias(l9_160));
float4 l9_168=l9_167;
if (param_39)
{
l9_168=mix(param_40,l9_168,float4(l9_102));
}
float4 l9_169=l9_168;
Color_N20=l9_169;
float4 Output_N21=float4(0.0);
float4 param_42=Output_N17;
float4 param_43=Color_N20;
float3 l9_170=param_43.xyz*param_42.xyz;
float4 param_44;
param_44=float4(l9_170.x,l9_170.y,l9_170.z,param_44.w);
float3 l9_171=mix(param_42.xyz,param_44.xyz,float3(param_43.w));
param_44=float4(l9_171.x,l9_171.y,l9_171.z,param_44.w);
param_44.w=param_42.w;
Output_N21=param_44;
...
float2 l9_173=floor(mod(l9_172.xy,float2(4.0)));
float l9_174=(mod(dot(l9_173,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_45<l9_174)
{
discard_fragment();
}
...
float4 l9_175=fast::max(param_46,float4(0.0));
float4 param_47=l9_175;
if (sc_ShaderCacheConstant_tmp!=0)
{
param_47.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=param_47;
return out;
}
float4 param_48=FinalColor;
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
float4 l9_176=param_48;
...
{
l9_178=fast::clamp(l9_177.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_178=fast::clamp(dot(l9_177.xyz,float3(l9_177.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_178=(1.0-dot(l9_177.xyz,float3(0.33333001)))*l9_177.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_178=(1.0-fast::clamp(dot(l9_177.xyz,float3(1.0)),0.0,1.0))*l9_177.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_178=fast::clamp(dot(l9_177.xyz,float3(1.0)),0.0,1.0)*l9_177.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_178=fast::clamp(dot(l9_177.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_178=dot(l9_177.xyz,float3(0.33333001))*l9_177.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_178=1.0-fast::clamp(dot(l9_177.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_179=l9_178;
float l9_180=l9_179;
float l9_181=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_180;
float3 l9_182=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_176.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_183=float4(l9_182.x,l9_182.y,l9_182.z,l9_181);
param_48=l9_183;
}
else
{
...
float4 l9_225=l9_186;
float3 l9_226=l9_225.xyz;
float3 l9_227=l9_226;
float3 l9_228=l9_184.xyz;
...
l9_185=float4(l9_229.x,l9_229.y,l9_229.z,l9_185.w);
float3 l9_230=mix(l9_226,l9_185.xyz,float3(l9_184.w));
l9_185=float4(l9_230.x,l9_230.y,l9_230.z,l9_185.w);
l9_185.w=1.0;
float4 l9_231=l9_185;
param_48=l9_231;
}
else
{
...
FinalColor=sc_OutputMotionVectorsIfNeeded(param_49,param_50,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_51=FinalColor;
float4 l9_243=param_51;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_243.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_243;
return out;
}
} // FRAGMENT SHADER
