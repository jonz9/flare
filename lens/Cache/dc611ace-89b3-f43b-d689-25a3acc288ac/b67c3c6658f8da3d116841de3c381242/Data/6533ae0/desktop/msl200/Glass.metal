...
//}
//ubo int UserUniforms 0:35:4912 {
//float4 sc_Time 1376
...
//int PreviewNodeID 4376
//float alphaTestThreshold 4380
//float reflIntensity 4384
//float3x3 planet_refl_mapTransform 4448
//float4 planet_refl_mapUvMinMax 4496
//float4 planet_refl_mapBorderColor 4512
//float4 Tweak_N2 4528
//float colorRatio 4544
//float4 Tweak_N8 4560
//float4 Tweak_N9 4576
//float3x3 Tweak_N6Transform 4640
//float4 Tweak_N6UvMinMax 4688
//float4 Tweak_N6BorderColor 4704
//float3 Port_Import_N013 4736
//float2 Port_Scale_N025 4752
//float2 Port_Center_N025 4760
//float Port_Rotation_N003 4768
//float2 Port_Center_N003 4776
//float4 Port_Input1_N029 4784
//float4 Port_Import_N038 4800
//float4 Port_Import_N031 4816
//float Port_Input0_N066 4832
//float Port_Input1_N066 4836
//float Port_RangeMinA_N033 4840
//float Port_RangeMaxA_N033 4844
//float Port_RangeMinB_N033 4848
//float Port_RangeMaxB_N033 4852
//float2 Port_Center_N047 4864
//float2 Port_Import_N058 4872
//float2 Port_Import_N060 4880
//float Port_Input1_N065 4888
//float Port_Input2_N065 4892
//float depthRef 4896
//}
...
constant int SC_SOFTWARE_WRAP_MODE_U_planet_refl_map [[function_constant(78)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map [[function_constant(81)]];
...
constant int planet_refl_mapLayout [[function_constant(84)]];
...
{
float l9_1=0.0;
float l9_2=(*sc_set0.UserUniforms).reflIntensity;
l9_1=l9_2;
float l9_3=0.0;
l9_3=l9_1;
float l9_4=0.0;
...
l9_5=(*sc_set0.UserUniforms).Port_Import_N013;
...
N15_NormalSpace=int(l9_7);
N15_Normal=l9_8;
float3 l9_11=N15_Normal;
if (N15_NormalSpace==1)
{
float3 l9_12=tempGlobals.VertexTangent_WorldSpace;
float3 l9_13=tempGlobals.VertexBinormal_WorldSpace;
float3 l9_14=tempGlobals.VertexNormal_WorldSpace;
float3x3 l9_15=float3x3(float3(l9_12),float3(l9_13),float3(l9_14));
l9_11=normalize(l9_15*l9_11);
}
float3 l9_16=tempGlobals.ViewDirWS;
float3 l9_17=normalize(-l9_16);
float3 l9_18=l9_17;
int l9_19=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_20=l9_19;
float3 l9_21=(*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_20][1].xyz;
float3 l9_22=normalize(cross(l9_18,l9_21));
float3 l9_23=cross(l9_22,l9_17);
float3x3 l9_24=float3x3(float3(l9_22.x,l9_23.x,l9_17.x),float3(l9_22.y,l9_23.y,l9_17.y),float3(l9_22.z,l9_23.z,l9_17.z));
l9_11=l9_24*l9_11;
N15_ReflectionUV=(l9_11.xy*0.5)+float2(0.5);
l9_10=N15_ReflectionUV;
l9_6=l9_10;
...
int l9_31=l9_26;
int l9_32=planet_refl_mapLayout_tmp;
int l9_33=l9_31;
float2 l9_34=l9_6;
bool l9_35=(int(SC_USE_UV_TRANSFORM_planet_refl_map_tmp)!=0);
float3x3 l9_36=(*sc_set0.UserUniforms).planet_refl_mapTransform;
int2 l9_37=int2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map_tmp,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map_tmp);
bool l9_38=(int(SC_USE_UV_MIN_MAX_planet_refl_map_tmp)!=0);
float4 l9_39=(*sc_set0.UserUniforms).planet_refl_mapUvMinMax;
bool l9_40=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map_tmp)!=0);
float4 l9_41=(*sc_set0.UserUniforms).planet_refl_mapBorderColor;
float l9_42=0.0;
...
float4 l9_109=sc_set0.planet_refl_map.sample(sc_set0.planet_refl_mapSmpSC,l9_108.xy,bias(l9_102));
...
l9_112=float4(l9_3)*l9_25;
float4 l9_113=float4(0.0);
l9_113=l9_112;
float2 l9_114=float2(0.0);
l9_114=param_4.Surface_UVCoord0;
float2 l9_115=float2(0.0);
l9_115=((l9_114-(*sc_set0.UserUniforms).Port_Center_N025)*(*sc_set0.UserUniforms).Port_Scale_N025)+(*sc_set0.UserUniforms).Port_Center_N025;
float2 l9_116=float2(0.0);
float2 l9_117=l9_115;
float l9_118=(*sc_set0.UserUniforms).Port_Rotation_N003;
float2 l9_119=(*sc_set0.UserUniforms).Port_Center_N003;
float l9_120=sin(radians(l9_118));
float l9_121=cos(radians(l9_118));
float2 l9_122=l9_117-l9_119;
l9_122=float2(dot(float2(l9_121,l9_120),l9_122),dot(float2(-l9_120,l9_121),l9_122))+l9_119;
l9_116=l9_122;
float4 l9_123=float4(0.0);
float4 l9_124=(*sc_set0.UserUniforms).Tweak_N2;
l9_123=l9_124;
float l9_125=0.0;
float l9_126=(*sc_set0.UserUniforms).colorRatio;
l9_125=l9_126;
float4 l9_127=float4(0.0);
float4 l9_128=(*sc_set0.UserUniforms).Tweak_N8;
l9_127=l9_128;
float4 l9_129=float4(0.0);
float4 l9_130=(*sc_set0.UserUniforms).Tweak_N9;
l9_129=l9_130;
float4 l9_131=float4(0.0);
float l9_132=l9_116.x;
float4 l9_133=l9_123;
float l9_134=l9_125;
float4 l9_135=l9_127;
float4 l9_136=l9_129;
l9_132=fast::clamp(l9_132,0.0,1.0);
float4 l9_137;
if (l9_132<l9_134)
{
l9_137=mix(l9_133,l9_135,float4(fast::clamp(l9_132/l9_134,0.0,1.0)));
}
else
{
l9_137=mix(l9_135,l9_136,float4(fast::clamp((l9_132-l9_134)/(1.0-l9_134),0.0,1.0)));
}
bool l9_138=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_139;
if (l9_138)
{
l9_139=!PreviewInfo.Saved;
}
else
{
l9_139=l9_138;
...
if (l9_139)
{
l9_140=0==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_140=l9_139;
...
PreviewInfo.Color=l9_137;
PreviewInfo.Color.w=1.0;
}
l9_131=l9_137;
float4 l9_141=float4(0.0);
l9_141=l9_113+l9_131;
float3 l9_142=float3(0.0);
float l9_143=0.0;
float4 l9_144=l9_141;
float3 l9_145=l9_144.xyz;
float l9_146=l9_144.w;
l9_142=l9_145;
l9_143=l9_146;
float4 l9_147=float4(0.0);
l9_147=(*sc_set0.UserUniforms).Port_Import_N038;
float4 l9_148=float4(0.0);
l9_148=(*sc_set0.UserUniforms).Port_Import_N031;
float2 l9_149=float2(0.0);
l9_149=param_4.Surface_UVCoord0;
float2 l9_150=float2(0.0);
l9_150=(((l9_149-float2((*sc_set0.UserUniforms).Port_RangeMinA_N033))/float2(((*sc_set0.UserUniforms).Port_RangeMaxA_N033-(*sc_set0.UserUniforms).Port_RangeMinA_N033)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N033-(*sc_set0.UserUniforms).Port_RangeMinB_N033))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N033);
float2 l9_151=float2(0.0);
l9_151=l9_114;
float2 l9_152=float2(0.0);
l9_152=((l9_150-(*sc_set0.UserUniforms).Port_Center_N047)*l9_151)+(*sc_set0.UserUniforms).Port_Center_N047;
float2 l9_153=float2(0.0);
l9_153=(*sc_set0.UserUniforms).Port_Import_N058;
float2 l9_154=float2(0.0);
l9_154=l9_152-l9_153;
float2 l9_155=float2(0.0);
l9_155=(*sc_set0.UserUniforms).Port_Import_N060;
float2 l9_156=float2(0.0);
l9_156=l9_155-l9_153;
float l9_157=0.0;
l9_157=dot(l9_154,l9_156);
float l9_158=0.0;
l9_158=dot(l9_156,l9_156);
float l9_159=0.0;
l9_159=l9_157/l9_158;
float l9_160=0.0;
l9_160=fast::clamp(l9_159+0.001,(*sc_set0.UserUniforms).Port_Input1_N065+0.001,(*sc_set0.UserUniforms).Port_Input2_N065+0.001)-0.001;
float l9_161=0.0;
l9_161=smoothstep((*sc_set0.UserUniforms).Port_Input0_N066,(*sc_set0.UserUniforms).Port_Input1_N066,l9_160);
float4 l9_162=float4(0.0);
l9_162=mix(l9_147,l9_148,float4(l9_161));
float4 l9_163=float4(0.0);
l9_163=l9_162;
float4 l9_164=float4(0.0);
l9_164=mix(float4(l9_143),(*sc_set0.UserUniforms).Port_Input1_N029,l9_163);
float4 l9_165=float4(0.0);
l9_165=float4(l9_142.x,l9_142.y,l9_142.z,l9_165.w);
l9_165.w=l9_164.x;
param_1=l9_165;
param_3=param_1;
}
...
{
float l9_166=0.0;
float l9_167=(*sc_set0.UserUniforms).reflIntensity;
l9_166=l9_167;
float l9_168=0.0;
l9_168=l9_166;
float l9_169=0.0;
...
l9_170=(*sc_set0.UserUniforms).Port_Import_N013;
float2 l9_171=float2(0.0);
float l9_172=l9_169;
float3 l9_173=l9_170;
ssGlobals l9_174=param_4;
tempGlobals=l9_174;
float2 l9_175=float2(0.0);
N15_NormalSpace=int(l9_172);
N15_Normal=l9_173;
float3 l9_176=N15_Normal;
if (N15_NormalSpace==1)
{
float3 l9_177=tempGlobals.VertexTangent_WorldSpace;
float3 l9_178=tempGlobals.VertexBinormal_WorldSpace;
float3 l9_179=tempGlobals.VertexNormal_WorldSpace;
float3x3 l9_180=float3x3(float3(l9_177),float3(l9_178),float3(l9_179));
l9_176=normalize(l9_180*l9_176);
}
float3 l9_181=tempGlobals.ViewDirWS;
float3 l9_182=normalize(-l9_181);
float3 l9_183=l9_182;
int l9_184=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_185=l9_184;
float3 l9_186=(*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_185][1].xyz;
float3 l9_187=normalize(cross(l9_183,l9_186));
float3 l9_188=cross(l9_187,l9_182);
float3x3 l9_189=float3x3(float3(l9_187.x,l9_188.x,l9_182.x),float3(l9_187.y,l9_188.y,l9_182.y),float3(l9_187.z,l9_188.z,l9_182.z));
l9_176=l9_189*l9_176;
N15_ReflectionUV=(l9_176.xy*0.5)+float2(0.5);
l9_175=N15_ReflectionUV;
l9_171=l9_175;
...
int l9_196=l9_191;
int l9_197=planet_refl_mapLayout_tmp;
int l9_198=l9_196;
float2 l9_199=l9_171;
bool l9_200=(int(SC_USE_UV_TRANSFORM_planet_refl_map_tmp)!=0);
float3x3 l9_201=(*sc_set0.UserUniforms).planet_refl_mapTransform;
int2 l9_202=int2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map_tmp,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map_tmp);
bool l9_203=(int(SC_USE_UV_MIN_MAX_planet_refl_map_tmp)!=0);
float4 l9_204=(*sc_set0.UserUniforms).planet_refl_mapUvMinMax;
bool l9_205=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map_tmp)!=0);
float4 l9_206=(*sc_set0.UserUniforms).planet_refl_mapBorderColor;
float l9_207=0.0;
bool l9_208=l9_205&&(!l9_203);
float l9_209=1.0;
float l9_210=l9_199.x;
int l9_211=l9_202.x;
if (l9_211==1)
{
l9_210=fract(l9_210);
...
if (l9_211==2)
{
float l9_212=fract(l9_210);
float l9_213=l9_210-l9_212;
float l9_214=step(0.25,fract(l9_213*0.5));
l9_210=mix(l9_212,1.0-l9_212,fast::clamp(l9_214,0.0,1.0));
}
}
l9_199.x=l9_210;
float l9_215=l9_199.y;
int l9_216=l9_202.y;
if (l9_216==1)
{
l9_215=fract(l9_215);
...
if (l9_216==2)
{
float l9_217=fract(l9_215);
float l9_218=l9_215-l9_217;
float l9_219=step(0.25,fract(l9_218*0.5));
l9_215=mix(l9_217,1.0-l9_217,fast::clamp(l9_219,0.0,1.0));
}
}
l9_199.y=l9_215;
if (l9_203)
...
float l9_222=l9_199.x;
float l9_223=l9_204.x;
float l9_224=l9_204.z;
bool l9_225=l9_221;
float l9_226=l9_209;
...
float l9_231=l9_199.y;
float l9_232=l9_204.y;
float l9_233=l9_204.w;
bool l9_234=l9_230;
float l9_235=l9_209;
...
float2 l9_238=l9_199;
bool l9_239=l9_200;
float3x3 l9_240=l9_201;
if (l9_239)
{
l9_238=float2((l9_240*float3(l9_238,1.0)).xy);
}
float2 l9_241=l9_238;
l9_199=l9_241;
float l9_242=l9_199.x;
int l9_243=l9_202.x;
bool l9_244=l9_208;
float l9_245=l9_209;
...
float4 l9_274=sc_set0.planet_refl_map.sample(sc_set0.planet_refl_mapSmpSC,l9_273.xy,bias(l9_267));
float4 l9_275=l9_274;
if (l9_205)
{
l9_275=mix(l9_206,l9_275,float4(l9_209));
}
float4 l9_276=l9_275;
l9_190=l9_276;
float4 l9_277=float4(0.0);
l9_277=float4(l9_168)*l9_190;
float4 l9_278=float4(0.0);
l9_278=l9_277;
float2 l9_279=float2(0.0);
l9_279=param_4.Surface_UVCoord0;
float2 l9_280=float2(0.0);
l9_280=((l9_279-(*sc_set0.UserUniforms).Port_Center_N025)*(*sc_set0.UserUniforms).Port_Scale_N025)+(*sc_set0.UserUniforms).Port_Center_N025;
float2 l9_281=float2(0.0);
float2 l9_282=l9_280;
float l9_283=(*sc_set0.UserUniforms).Port_Rotation_N003;
float2 l9_284=(*sc_set0.UserUniforms).Port_Center_N003;
...
float4 l9_289=(*sc_set0.UserUniforms).Tweak_N2;
l9_288=l9_289;
float l9_290=0.0;
float l9_291=(*sc_set0.UserUniforms).colorRatio;
l9_290=l9_291;
float4 l9_292=float4(0.0);
float4 l9_293=(*sc_set0.UserUniforms).Tweak_N8;
l9_292=l9_293;
float4 l9_294=float4(0.0);
float4 l9_295=(*sc_set0.UserUniforms).Tweak_N9;
l9_294=l9_295;
float4 l9_296=float4(0.0);
float l9_297=l9_281.x;
float4 l9_298=l9_288;
float l9_299=l9_290;
float4 l9_300=l9_292;
float4 l9_301=l9_294;
l9_297=fast::clamp(l9_297,0.0,1.0);
float4 l9_302;
if (l9_297<l9_299)
{
l9_302=mix(l9_298,l9_300,float4(fast::clamp(l9_297/l9_299,0.0,1.0)));
}
else
{
l9_302=mix(l9_300,l9_301,float4(fast::clamp((l9_297-l9_299)/(1.0-l9_299),0.0,1.0)));
}
bool l9_303=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_304;
if (l9_303)
{
l9_304=!PreviewInfo.Saved;
}
else
{
l9_304=l9_303;
...
if (l9_304)
{
l9_305=0==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_305=l9_304;
...
{
PreviewInfo.Saved=true;
PreviewInfo.Color=l9_302;
PreviewInfo.Color.w=1.0;
}
l9_296=l9_302;
float4 l9_306=float4(0.0);
l9_306=l9_278+l9_296;
param_2=l9_306;
param_3=param_2;
}
Result_N55=param_3;
...
int l9_312=l9_307;
int param_5=Tweak_N6Layout_tmp;
int param_6=l9_312;
float2 param_7=UVCoord_N19;
bool param_8=(int(SC_USE_UV_TRANSFORM_Tweak_N6_tmp)!=0);
float3x3 param_9=(*sc_set0.UserUniforms).Tweak_N6Transform;
int2 param_10=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6_tmp);
bool param_11=(int(SC_USE_UV_MIN_MAX_Tweak_N6_tmp)!=0);
float4 param_12=(*sc_set0.UserUniforms).Tweak_N6UvMinMax;
bool param_13=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6_tmp)!=0);
float4 param_14=(*sc_set0.UserUniforms).Tweak_N6BorderColor;
float param_15=0.0;
bool l9_313=param_13&&(!param_11);
float l9_314=1.0;
float l9_315=param_7.x;
int l9_316=param_10.x;
if (l9_316==1)
{
l9_315=fract(l9_315);
}
...
param_7.x=l9_315;
float l9_320=param_7.y;
int l9_321=param_10.y;
if (l9_321==1)
{
l9_320=fract(l9_320);
}
...
float l9_327=param_7.x;
float l9_328=param_12.x;
float l9_329=param_12.z;
bool l9_330=l9_326;
float l9_331=l9_314;
...
float l9_336=param_7.y;
float l9_337=param_12.y;
float l9_338=param_12.w;
bool l9_339=l9_335;
float l9_340=l9_314;
...
float2 l9_343=param_7;
bool l9_344=param_8;
float3x3 l9_345=param_9;
if (l9_344)
{
...
param_7=l9_346;
float l9_347=param_7.x;
int l9_348=param_10.x;
bool l9_349=l9_313;
float l9_350=l9_314;
...
param_7.x=l9_347;
l9_314=l9_350;
float l9_358=param_7.y;
int l9_359=param_10.y;
bool l9_360=l9_313;
float l9_361=l9_314;
...
param_7.y=l9_358;
l9_314=l9_361;
float2 l9_369=param_7;
int l9_370=param_5;
int l9_371=param_6;
float l9_372=param_15;
...
float4 l9_379=sc_set0.Tweak_N6.sample(sc_set0.Tweak_N6SmpSC,l9_378.xy,bias(l9_372));
float4 l9_380=l9_379;
if (param_13)
{
l9_380=mix(param_14,l9_380,float4(l9_314));
}
float4 l9_381=l9_380;
Color_N20=l9_381;
float4 Output_N21=float4(0.0);
float4 param_16=Result_N55;
float4 param_17=Color_N20;
float3 l9_382=param_17.xyz*param_16.xyz;
float4 param_18;
param_18=float4(l9_382.x,l9_382.y,l9_382.z,param_18.w);
float3 l9_383=mix(param_16.xyz,param_18.xyz,float3(param_17.w));
param_18=float4(l9_383.x,l9_383.y,l9_383.z,param_18.w);
param_18.w=param_16.w;
Output_N21=param_18;
...
float4 l9_387=fast::max(param_20,float4(0.0));
float4 param_21=l9_387;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_390=fast::clamp(l9_389.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_390=fast::clamp(dot(l9_389.xyz,float3(l9_389.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_390=(1.0-dot(l9_389.xyz,float3(0.33333001)))*l9_389.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_390=(1.0-fast::clamp(dot(l9_389.xyz,float3(1.0)),0.0,1.0))*l9_389.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_390=fast::clamp(dot(l9_389.xyz,float3(1.0)),0.0,1.0)*l9_389.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_390=fast::clamp(dot(l9_389.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_390=dot(l9_389.xyz,float3(0.33333001))*l9_389.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_390=1.0-fast::clamp(dot(l9_389.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_391=l9_390;
float l9_392=l9_391;
float l9_393=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_392;
float3 l9_394=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_388.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_395=float4(l9_394.x,l9_394.y,l9_394.z,l9_393);
param_22=l9_395;
}
else
{
...
{
float4 l9_396=param_22;
float4 l9_397=float4(0.0);
float4 l9_398=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_399=out.FragColor0;
float4 l9_400=l9_399;
l9_398=l9_400;
}
else
{
float4 l9_401=gl_FragCoord;
float2 l9_402=l9_401.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_407=l9_406;
int l9_408=l9_407;
float3 l9_409=float3(l9_403,0.0);
int l9_410=l9_405;
int l9_411=l9_408;
if (l9_410==1)
{
l9_409.y=((2.0*l9_409.y)+float(l9_411))-1.0;
}
float2 l9_412=l9_409.xy;
l9_404=l9_412;
}
else
{
...
int l9_423=l9_418;
float2 l9_424=l9_416;
int l9_425=sc_ScreenTextureLayout_tmp;
int l9_426=l9_423;
float l9_427=l9_417;
...
float4 l9_434=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_433.xy,bias(l9_427));
float4 l9_435=l9_434;
float4 l9_436=l9_435;
l9_398=l9_436;
}
float4 l9_437=l9_398;
float3 l9_438=l9_437.xyz;
float3 l9_439=l9_438;
float3 l9_440=l9_396.xyz;
float3 l9_441=definedBlend(l9_439,l9_440,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_397=float4(l9_441.x,l9_441.y,l9_441.z,l9_397.w);
float3 l9_442=mix(l9_438,l9_397.xyz,float3(l9_396.w));
l9_397=float4(l9_442.x,l9_442.y,l9_442.z,l9_397.w);
l9_397.w=1.0;
float4 l9_443=l9_397;
param_22=l9_443;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_444=float4(in.varScreenPos.xyz,1.0);
param_22=l9_444;
}
else
{
...
float l9_446=fast::clamp(abs(l9_445.z),0.0,1.0);
float4 l9_447=float4(l9_446,1.0-l9_446,1.0,1.0);
param_22=l9_447;
}
else
{
float4 l9_448=param_22;
float4 l9_449=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_449=float4(mix(float3(1.0),l9_448.xyz,float3(l9_448.w)),l9_448.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_450=l9_448.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_450=fast::clamp(l9_450,0.0,1.0);
}
l9_449=float4(l9_448.xyz*l9_450,l9_450);
}
else
{
l9_449=l9_448;
...
FinalColor=sc_OutputMotionVectorsIfNeeded(param_23,param_24,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_25=FinalColor;
float4 l9_455=param_25;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_455.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_455;
return out;
}
} // FRAGMENT SHADER
