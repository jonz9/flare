...
{
float4 l9_150=gl_FragCoord;
float2 l9_151=l9_150.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_156=l9_155;
int l9_157=l9_156;
float3 l9_158=float3(l9_152,0.0);
int l9_159=l9_154;
int l9_160=l9_157;
if (l9_159==1)
{
l9_158.y=((2.0*l9_158.y)+float(l9_160))-1.0;
}
float2 l9_161=l9_158.xy;
l9_153=l9_161;
}
else
{
...
float4 l9_183=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_182.xy,bias(l9_176));
float4 l9_184=l9_183;
float4 l9_185=l9_184;
l9_147=l9_185;
}
float4 l9_186=l9_147;
float3 l9_187=l9_186.xyz;
float3 l9_188=l9_187;
float3 l9_189=l9_145.xyz;
float3 l9_190=definedBlend(l9_188,l9_189,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_146=float4(l9_190.x,l9_190.y,l9_190.z,l9_146.w);
float3 l9_191=mix(l9_187,l9_146.xyz,float3(l9_145.w));
l9_146=float4(l9_191.x,l9_191.y,l9_191.z,l9_146.w);
l9_146.w=1.0;
float4 l9_192=l9_146;
param_8=l9_192;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_193=float4(in.varScreenPos.xyz,1.0);
param_8=l9_193;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_194=gl_FragCoord;
float l9_195=fast::clamp(abs(l9_194.z),0.0,1.0);
float4 l9_196=float4(l9_195,1.0-l9_195,1.0,1.0);
param_8=l9_196;
}
else
{
float4 l9_197=param_8;
