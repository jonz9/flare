...
//sampler sampler texture_mapSmpSC 0:32
...
//texture texture2D texture_map 0:21:0:32
...
//float3x3 texture_mapTransform 4432
//float4 texture_mapUvMinMax 4480
//float4 texture_mapBorderColor 4496
//float Tweak_N44 4512
//float black_height 4516
//float Port_Multiplier_N039 4520
//float Port_Input1_N041 4524
//float Port_Input1_N043 4528
//float4 Port_Value0_N038 4544
//float Port_Position1_N038 4560
//float4 Port_Value1_N038 4576
//float4 Port_Value2_N038 4592
//float Port_Input0_N000 4608
//float Port_Input1_N000 4612
//float Port_Input0_N003 4616
//float Port_Input1_N003 4620
//float Port_Input0_N014 4624
//float Port_Input1_N014 4628
//float Port_Input1_N013 4632
//float2 Port_Scale_N032 4640
//float2 Port_Center_N032 4648
//float Port_Input1_N034 4656
//float2 Port_Direction_N037 4664
//float Port_Input1_N046 4672
//float Port_Input0_N045 4676
//float Port_Input1_N045 4680
//float Port_Input1_N047 4684
//float depthRef 4688
//}
...
//spec_const bool texture_mapHasSwappedViews 70 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_texture_map 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_texture_map 74 -1
...
//spec_const int texture_mapLayout 83 0
//SG_REFLECTION_END
...
constant bool texture_mapHasSwappedViews [[function_constant(70)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_texture_map [[function_constant(72)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_texture_map [[function_constant(74)]];
...
constant int texture_mapLayout [[function_constant(83)]];
...
texture2d<float> texture_map [[id(21)]];
...
sampler texture_mapSmpSC [[id(32)]];
...
float param_1=Output_N43;
float4 param_2=(*sc_set0.UserUniforms).Port_Value0_N038;
float param_3=(*sc_set0.UserUniforms).Port_Position1_N038;
float4 param_4=(*sc_set0.UserUniforms).Port_Value1_N038;
float4 param_5=(*sc_set0.UserUniforms).Port_Value2_N038;
param_1=fast::clamp(param_1,0.0,1.0);
float4 param_6;
if (param_1<param_3)
{
param_6=mix(param_2,param_4,float4(fast::clamp(param_1/param_3,0.0,1.0)));
}
else
{
param_6=mix(param_4,param_5,float4(fast::clamp((param_1-param_3)/(1.0-param_3),0.0,1.0)));
}
bool l9_1=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_2;
if (l9_1)
{
l9_2=!PreviewInfo.Saved;
}
else
{
l9_2=l9_1;
...
if (l9_2)
{
l9_3=38==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_3=l9_2;
...
float param_7=(*sc_set0.UserUniforms).Tweak_N44;
Output_N44=param_7;
...
int l9_9=l9_4;
int param_8=texture_mapLayout_tmp;
int param_9=l9_9;
float2 param_10=CoordsOut_N37;
bool param_11=(int(SC_USE_UV_TRANSFORM_texture_map_tmp)!=0);
float3x3 param_12=(*sc_set0.UserUniforms).texture_mapTransform;
int2 param_13=int2(SC_SOFTWARE_WRAP_MODE_U_texture_map_tmp,SC_SOFTWARE_WRAP_MODE_V_texture_map_tmp);
bool param_14=(int(SC_USE_UV_MIN_MAX_texture_map_tmp)!=0);
float4 param_15=(*sc_set0.UserUniforms).texture_mapUvMinMax;
bool param_16=(int(SC_USE_CLAMP_TO_BORDER_texture_map_tmp)!=0);
float4 param_17=(*sc_set0.UserUniforms).texture_mapBorderColor;
float param_18=0.0;
bool l9_10=param_16&&(!param_14);
float l9_11=1.0;
float l9_12=param_10.x;
int l9_13=param_13.x;
if (l9_13==1)
{
l9_12=fract(l9_12);
}
...
param_10.x=l9_12;
float l9_17=param_10.y;
int l9_18=param_13.y;
if (l9_18==1)
{
l9_17=fract(l9_17);
}
...
float l9_24=param_10.x;
float l9_25=param_15.x;
float l9_26=param_15.z;
bool l9_27=l9_23;
float l9_28=l9_11;
...
float l9_33=param_10.y;
float l9_34=param_15.y;
float l9_35=param_15.w;
bool l9_36=l9_32;
float l9_37=l9_11;
...
float2 l9_40=param_10;
bool l9_41=param_11;
float3x3 l9_42=param_12;
if (l9_41)
{
...
float2 l9_43=l9_40;
param_10=l9_43;
float l9_44=param_10.x;
int l9_45=param_13.x;
bool l9_46=l9_10;
float l9_47=l9_11;
if ((l9_45==0)||(l9_45==3))
{
...
param_10.x=l9_44;
l9_11=l9_47;
float l9_55=param_10.y;
int l9_56=param_13.y;
bool l9_57=l9_10;
float l9_58=l9_11;
if ((l9_56==0)||(l9_56==3))
{
...
param_10.y=l9_55;
l9_11=l9_58;
float2 l9_66=param_10;
int l9_67=param_8;
int l9_68=param_9;
float l9_69=param_18;
float2 l9_70=l9_66;
int l9_71=l9_67;
int l9_72=l9_68;
...
float3 l9_74=l9_73;
float3 l9_75=l9_74;
float4 l9_76=sc_set0.texture_map.sample(sc_set0.texture_mapSmpSC,l9_75.xy,bias(l9_69));
float4 l9_77=l9_76;
if (param_16)
{
l9_77=mix(param_17,l9_77,float4(l9_11));
}
float4 l9_78=l9_77;
Color_N27=l9_78;
...
float param_19=(*sc_set0.UserUniforms).black_height;
Output_N51=param_19;
...
float4 l9_82=fast::max(param_21,float4(0.0));
float4 param_22=l9_82;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float3 l9_137=mix(l9_133,l9_92.xyz,float3(l9_91.w));
l9_92=float4(l9_137.x,l9_137.y,l9_137.z,l9_92.w);
l9_92.w=1.0;
float4 l9_138=l9_92;
param_23=l9_138;
}
